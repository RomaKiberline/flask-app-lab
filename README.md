...
![Додавання постів](./screens/posts.png)
...
![Список всіх постів](./screens/post.png)
![Список активних постів](./screens/active_post.png)
![Список неактивних постів](./screens/inactive_post.png)

#### Перегляд поста
![Перегляд поста](./screens/post_view.png)

#### Додавання нового поста
![Додавання поста](./screens/creating_post.png)
![Додавання поста](./screens/created_post.png)

#### Редагування поста
![Редагування поста](./screens/edit_post.png)
![Редагування поста](./screens/post_updated.png)

#### Видалення поста
![Видалення поста](./screens/delete_post.png)
![Видалення поста](./screens/post_deleted.png)

### Модульні тести
![Тести](./screens/test.png)
